...
client.on('message', msg => {
  if (msg.content === prefix +'avatar') {
    msg.channel.send({embed: {
      color: 0x0,
      image: {
        url: msg.aconst Discord = require('discord.js');
const client = new Discord.Client();
require('./util/eventloader')(client);
const servers={
...
client.login(`NzkxOTc3OTU3MDEwNzAyMzY3.X-XA8w.wj9FUU0DyJ64nUmFArDxUNHWvzE`);uthor.displayAvatarURL()
    }}});
  };
});
client.on('message', msg => {
...
client.login(`discord.com/developers/791977957010702367/bot`);
